...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    switch (event) {
        ...
        case ESP_GATTS_CREATE_EVT:
            ...
            memcpy(gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid128 , adv_service_uuid128,ESP_UUID_LEN_128);
            //gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 = 0x0002;
            gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid128[12] = 0x02;
        ...
        case ESP_GATTS_ADD_CHAR_EVT: {
            ...
            //memcpy(gl_profile_tab[PROFILE_A_APP_ID].descr_uuid.uuid.uuid128 , adv_service_uuid128,ESP_UUID_LEN_128);
            //gl_profile_tab[PROFILE_A_APP_ID].descr_uuid.uuid.uuid128[12] = 0x03;
