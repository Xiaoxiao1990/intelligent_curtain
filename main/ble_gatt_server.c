...
#define TEST_DEVICE_NAME            "Curtain"
...
typedef struct {
    ...
    profile_char_t chars[PROFILE_A_CHAR_NUM];
} gatts_profile_t;

/* One gatt-based profile one app_id and one gatts_if, this array will store the gatts_if returned by ESP_GATTS_REG_EVT */
static gatts_profile_t gl_profile_tab;
...
static void gatts_profile_init(void)
{
    ...
    gl_profile_tab.gatts_cb = gatts_profile_a_event_handler;
    ...
    memcpy(gl_profile_tab.service_id.id.uuid.uuid.uuid128 , adv_service_uuid128, ESP_UUID_LEN_128);
    ...
    gl_profile_tab.chars[1].descr_uuid.uuid.uuid16 = ESP_GATT_UUID_CHAR_CLIENT_CONFIG;
}
...
static void uart_profile_parse(esp_gatt_if_t gatts_if, prepare_type_env_t *prepare_write_env, esp_ble_gatts_cb_param_t *param){
    esp_gatt_status_t status = ESP_GATT_OK;
                ...
                switch (data[1]) {
                    ...
                    case 0x02:
                        if (data[2] == 0x01) {
                            ...
                            ESP_LOGI(GATTS_TAG, "Motor control");
                        } else {
                            ESP_LOGE(GATTS_TAG, "Undefined operation");
                        }
                        break;
...
/*            if (!param->write.is_prep){
            ...
            uart_profile_parse(gatts_if, &a_prepare_write_env, param);
        ...
        case ESP_GATTS_ADD_CHAR_EVT: {
            ...
            gl_profile_tab.chars[char_cnt].char_handle = param->add_char.attr_handle;
            ...
            esp_err_t add_descr_ret = esp_ble_gatts_add_char_descr(gl_profile_tab.service_handle, &gl_profile_tab.chars[char_cnt].descr_uuid,
                                                                   gl_profile_tab.chars[char_cnt].perm, NULL, NULL);
            if (add_descr_ret){
        ...
        case ESP_GATTS_ADD_CHAR_DESCR_EVT:
            gl_profile_tab.chars[char_cnt++].descr_handle = param->add_char_descr.attr_handle;
...
//                                                  gl_profile_tab.chars[1].perm,
//                                                  gl_profile_tab.chars[1].property,
...
void ble_gatt_server_unit_test(void)
{
    esp_err_t ret;
